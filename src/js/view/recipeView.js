...
export const highlightSelectedRecipe = id =>{
    ...
    const el = document.querySelector(`a.results__link[href="#${id}"]`);
    if(el){
        el.classList.add('results__link--active');
    } else console.log('element oldsongui')
}
export const clearRecipe = () =>{
    //Odoo delgets deer haragdaj baigaa joriig arilgana
    elements.recipeDiv.innerHTML = "";
}
export const renderRecipe = (recipe, isLiked) => {
    //ene joriig delgetsend gargaj uzuulne
    const html = `
